import { ACTIVITIES, PACKAGES } from "../data/packages.js?v=33";
import { DESTINATIONS, VISA_TYPES, PAGE_COPY } from "../data/content.js?v=33";
import { SERVICES } from "../data/navigation.js?v=33";
