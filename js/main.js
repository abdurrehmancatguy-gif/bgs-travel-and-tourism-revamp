import { SCENE } from "../data/images.js?v=43";
import { SCENES, SERVICES } from "../data/navigation.js?v=43";
import { findPackageBySlug } from "../data/packages.js?v=43";
import { icon } from "../data/icons.js?v=43";
import {
  buildCustomTripUrl,
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=43";
import { createNavigation } from "./navigation.js?v=43";
import { createCarousel } from "./carousel.js?v=43";
import { createPackageDialog } from "./package-dialog.js?v=43";
