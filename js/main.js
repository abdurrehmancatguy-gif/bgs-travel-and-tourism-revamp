import { SCENE } from "../data/images.js?v=83";
import "./info-modal.js?v=83";
import { SCENES, SERVICES } from "../data/navigation.js?v=83";
import { findPackageBySlug } from "../data/packages.js?v=83";
...
import {
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=83";
import { createNavigation } from "./navigation.js?v=83";
import { createCarousel } from "./carousel.js?v=83";
import { createPackageDialog } from "./package-dialog.js?v=83";
