import { SCENE } from "../data/images.js?v=135";
import "./info-modal.js?v=135";
import { SCENES } from "../data/navigation.js?v=135";
import { findPackageBySlug } from "../data/packages.js?v=135";
...
import { createCarousel } from "./carousel.js?v=135";
import { openItem } from "./item-dialog.js?v=135";
import { createPackageDialog } from "./package-dialog.js?v=135";
