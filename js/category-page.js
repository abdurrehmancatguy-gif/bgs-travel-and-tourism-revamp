...
import { priceLabel } from "../data/packages.js?v=85";
import { openWhatsApp, buildWhatsAppUrl } from "../utils/whatsapp.js?v=85";
import { MICE_SERVICES } from "../data/mice.js?v=85";
import { openItem } from "./item-dialog.js?v=85";
