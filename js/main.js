import { SCENE } from "../data/images.js?v=52";
import { SCENES, SERVICES } from "../data/navigation.js?v=52";
import { findPackageBySlug } from "../data/packages.js?v=52";
...
import {
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=52";
import { createNavigation } from "./navigation.js?v=52";
import { createCarousel } from "./carousel.js?v=52";
import { createPackageDialog } from "./package-dialog.js?v=52";
