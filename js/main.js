import { SCENE } from "../data/images.js?v=54";
import { SCENES, SERVICES } from "../data/navigation.js?v=54";
import { findPackageBySlug } from "../data/packages.js?v=54";
...
import {
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=54";
import { createNavigation } from "./navigation.js?v=54";
import { createCarousel } from "./carousel.js?v=54";
import { createPackageDialog } from "./package-dialog.js?v=54";
