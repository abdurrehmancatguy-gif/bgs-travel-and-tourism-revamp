...
import { priceLabel } from "../data/packages.js?v=122";
import { openWhatsApp, buildWhatsAppUrl } from "../utils/whatsapp.js?v=122";
import { MICE_SERVICES } from "../data/mice.js?v=122";
import { openItem, itemTitle } from "./item-dialog.js?v=122";
import { track } from "./analytics.js?v=122";
import { contactStripMarkup } from "./info-modal.js?v=122";
