import { getCollection, subscribe } from "./store.js?v=38";
import { createNavigation } from "./navigation.js?v=38";
import { icon } from "../data/icons.js?v=38";
import { priceLabel } from "../data/packages.js?v=38";
import { openWhatsApp, buildWhatsAppUrl } from "../utils/whatsapp.js?v=38";
