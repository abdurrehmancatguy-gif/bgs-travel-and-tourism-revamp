import { ACTIVITIES, PACKAGES } from "../data/packages.js?v=38";
import { DESTINATIONS, VISA_TYPES, PAGE_COPY } from "../data/content.js?v=38";
import { SERVICES } from "../data/navigation.js?v=38";
