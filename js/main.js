import { SCENE } from "../data/images.js?v=37";
import { SCENES, SERVICES } from "../data/navigation.js?v=37";
import { findPackageBySlug } from "../data/packages.js?v=37";
import { icon } from "../data/icons.js?v=37";
import {
  buildCustomTripUrl,
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=37";
import { createNavigation } from "./navigation.js?v=37";
import { createCarousel } from "./carousel.js?v=37";
import { createPackageDialog } from "./package-dialog.js?v=37";
