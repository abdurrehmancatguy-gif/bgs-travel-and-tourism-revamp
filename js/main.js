import { SCENE } from "../data/images.js?v=90";
import "./info-modal.js?v=90";
import { SCENES } from "../data/navigation.js?v=90";
import { findPackageBySlug } from "../data/packages.js?v=90";
...
import {
  ...
  CONTACT_EMAIL,
  WHATSAPP_DISPLAY,
} from "../utils/whatsapp.js?v=90";
import { createNavigation } from "./navigation.js?v=90";
import { getCollection, subscribe } from "./store.js?v=90";
import { createCarousel } from "./carousel.js?v=90";
import { createPackageDialog } from "./package-dialog.js?v=90";
